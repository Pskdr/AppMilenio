...
public interface GrupoZonaDAO {
    @Query("select GrupoZonas.id as id, :idOrden as idOrden,zonas.descripcion as nombre,GrupoZonas.producto as producto,GrupoZonas.ingredienteActivo as ingredienteActivo," +
